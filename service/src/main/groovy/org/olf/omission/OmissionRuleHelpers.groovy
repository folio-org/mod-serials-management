...
@CompileStatic
@Slf4j
public class OmissionRuleHelpers {
	...
	public static <T extends OmissionPattern> T doRulePatternBinding( OmissionRule obj, SimpleMapDataBindingSource source) {
		...
		final Class<? extends OmissionPattern> rc = Class.forName(patternClasspathString)
		...
		log.debug ('Binding Omission Pattern of type {} to Object {}', rp, obj)
	...
	private static void validateRulePattern ( OmissionPattern value, OmissionRule instance, Errors err ) {
