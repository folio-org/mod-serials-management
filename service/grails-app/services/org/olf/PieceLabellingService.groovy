...
public class PieceLabellingService {
  ...
  public ArrayList<ChronologyTemplateMetadata> generateChronologyMetadata(StandardTemplateMetadata standardTM, List<TemplateMetadataRule> templateMetadataRules) {
